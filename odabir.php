    ...
    <div class="container">
        <div class="sredina">
            <div class="row">
                <div class="col">
                    <div class="naslovi">
                        <h2 style="margin-bottom: 30px;">DODAJ/OBRIŠI VOZAČA</h2>
                    </div>
                    <div class="row" style="justify-content: center;">
                        <a href="dodajkorisnik.php" class="prijava">
                            <div class="col">
                                <div class="card border-dark" style="width: 200px; text-align: center;">
                                    <img class="card-img-top" src="img/add-user.png" alt="Card image cap" style="padding: 10px; width:100px; margin: 0 auto;">
                                    <div class="card-body">
                        ...
                        <a href="uklonikorisnik.php" class="prijava">
                            <div class="col">
                                <div class="card border-dark" style="width: 200px; text-align: center;">
                                    <img class="card-img-top" src="img/remove-user.png" alt="Card image cap" style="padding: 10px; width:100px; margin: 0 auto;">
                                    <div class="card-body">
                                        <p class="card-text">OBRIŠI VOZAČA</p>
                                    </div>
                                </div>
                            </div>
                        </a>
