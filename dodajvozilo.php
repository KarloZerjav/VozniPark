    ...
    <div class="container">
        <div class="sredina">
            <div class="row">
                <div class="col">
                    <div class="naslovi">
                        <h2 style="margin-bottom: 30px;">DODAJ VOZILO</h2>
                    </div>
                    <div class="row" style="justify-content: center;">
                        <a href="dodajkamion.php" class="prijava">
                            <div class="col">
                                <div class="card border-dark" style="width: 200px; text-align: center;">
                                    <img class="card-img-top" src="img/semi-truck.png" alt="Card image cap" style="padding: 10px; width:100px; margin: 0 auto;">
                                    <div class="card-body">
                                        <p class="card-text">DODAJ KAMION</p>
                                    </div>
                                </div>
                            </div>
                        </a>
                        <a href="dodajprikolicu.php" class="prijava">
                            <div class="col">
                                <div class="card border-dark" style="width: 200px; text-align: center;">
                                    <img class="card-img-top" src="img/trailer.png" alt="Card image cap" style="padding: 10px; width:100px; margin: 0 auto; transform: scaleX(-1);">
                                    <div class="card-body">
                                        <p class="card-text">DODAJ PRIKOLICU</p>
                                    </div>
                                </div>
                            </div>
                        </a>
