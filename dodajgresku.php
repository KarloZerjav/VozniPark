...
if (isset($_POST['insert'])) {
    if (isset($_POST['kod_greske'], $_POST['opis_greske'])) {
        // Prepare the SQL statement
        $insertQuery = "INSERT INTO greske (kod_greske, opis_greske) VALUES (?, ?)";

        // Prepare the statement
        $stmt = mysqli_prepare($dbc, $insertQuery);

        // Bind the parameters
        mysqli_stmt_bind_param($stmt, "ss", $kod, $opis);

        // Sanitize and set the parameters from the POST data
        $kod = mysqli_real_escape_string($dbc, $_POST['kod_greske']);
        $opis = mysqli_real_escape_string($dbc, $_POST['opis_greske']);
...
<body>
    <div class="adresa">
        <ul class="nav justify-content-center">
            <li class="nav-item">
                ...
                <a class="a_adresa" rel="noreferrer noopener" href="https://www.google.com/maps/place/Dru%C5%A1kovec+Humski+82-1,+49231,+Dru%C5%A1kovec+Humski/@46.1895199,15.7004897,15.01z/data=!4m5!3m4!1s0x476591ed9ab6a98b:0x6936023145828a2!8m2!3d46.188583!4d15.7004335" target="_blank">
                    Druškovec Humski 82/1, 49231 Hum na Sutli, Hrvatska
                </a>&nbsp;&nbsp;&nbsp;&nbsp;
            </li>
            <li class="nav-item">
                <img style="width: 15px;" src="img/mail.svg" alt="">
                e-mail:
                <a class="a_adresa" href="mailto:info@kompanija-zerjav-transporti.hr">
                    info@kompanija-zerjav-transporti.hr
                </a>
                &nbsp;&nbsp;&nbsp;&nbsp;
            </li>
            <li class="nav-item">
            ...
            <div class="container">
                <div class="container">
                    <div class="responzivno row">
                        <div class="col">
                            <a href="https://kompanija-zerjav-transporti.hr/">
                                <img class="navbar_slika" src="img/LogoZerjav.svg" alt="">
                            </a>
                        </div>
                        <div class="col gumb_pozicija">
                            <a href="greske.php">
                                <button type="button" class="btn btn-outline-dark gumb">
                                    <img style="width: 30px;" src="img/natrag.png" alt="">
                                </button>
                            </a>
                            <a href="izbornik.php"><button type="button" class="btn btn-outline-dark gumb">
                                    <img style="width: 30px;" src="img/home.png" alt="">
                                </button>
                            </a>
                            <?php
                            if (!empty($user)) {
    ...
    <div class="container">
        <div class="sredina">
            <div class="naslovi">
                <h2 style="margin-bottom: 30px;">DODAJ GREŠKU</h2>
            </div>
            <form enctype="multipart/form-data" action="" method="POST">
                <div class="form-group forma_servis row">
                    <label for="kod_greske" class="col-sm-3">Kod:</label>
                    <div class="col-sm-9">
                        <input type="text" name="kod_greske" id="kod_greske" class="form-control forma_input" required>
                    </div>
                </div>
                <div class="form-group forma_servis row">
                    <label for="opis_greske" class="col-sm-3">Opis:</label>
                    <div class="col-sm-9">
                        <textarea name="opis_greske" id="opis_greske" class="form-control forma_input" rows="4" cols="25" required></textarea>
                    </div>
                </div>
